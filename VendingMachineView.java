...
public class VendingMachineView extends JPanel {
                        ...
                        if (totalAmount >= price && vendingMachine.getItemSlot().get(index).getItemQuantity() > 0) {
                            ...
                            if (canProvideChange) {
                                ...
                                if (changeOption == JOptionPane.NO_OPTION) {
                                    ...
                                    addTransaction(vendingMachine.getItemSlot().get(index).getDesignatedItem());
    ...
    public void addTransaction(ItemModel item) {
        boolean foundItem = false;

for (TransactionModel tr : vendingMachine.getTransactions()) {
...
if (!foundItem) {
    vendingMachine.getTransactions().add(new TransactionModel(item, 1));
}
    ...
    public static void showOptionPaneWithButtons() {
        ...
        // Show the JOptionPane with the array of JButtons as the options
        int choice = JOptionPane.showOptionDialog(
                null,
                "Choose a button:",
                "JOptionPane with Buttons Example",
        ...
        // The choice will be the index of the clicked button (0 for Button 1, 1 for Button 2, etc.)
        if (choice != JOptionPane.CLOSED_OPTION) {
            System.out.println("Button " + (choice + 1) + " clicked.");
        } else {
            System.out.println("Dialog closed without selecting any button.");
        }
    }

    // Example of calling the method from the main program
    public static void main(String[] args) {
        showOptionPaneWithButtons();
    }
}
